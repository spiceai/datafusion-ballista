...
pub struct BallistaExplainNode {
    ...
    #[prost(string, tag = "2")]
    pub explain_format: ::prost::alloc::string::String,
}
...
#[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
pub struct BallistaLogicalExtensionNode {
    #[prost(oneof = "ballista_logical_extension_node::Node", tags = "1")]
    pub node: ::core::option::Option<ballista_logical_extension_node::Node>,
}
/// Nested message and enum types in `BallistaLogicalExtensionNode`.
pub mod ballista_logical_extension_node {
    #[derive(Clone, PartialEq, Eq, Hash, ::prost::Oneof)]
    pub enum Node {
        #[prost(message, tag = "1")]
        Explain(super::BallistaExplainNode),
    }
}
#[derive(Clone, PartialEq, ::prost::Message)]
